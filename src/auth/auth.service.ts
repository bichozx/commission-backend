...
export class AuthService {
  ...
  //   // Determinar nivel y commission rate
  //   // let level = 1;
  //   // let commissionRate = 10; // 10%
  ...
  //   //     level = Math.min(parentAffiliate.level + 1, 3);
  //   let level = 1;
  //   const commissionRate = 0; // CAMBIAR: 0 en lugar de 10
  //   let parentId: string | null = null;
  ...
  //     if (parentAffiliate) {
  //       parentId = parentAffiliate.id;
  //       level = parentAffiliate.level + 1; //Math.min(parentAffiliate.level + 1, 3);

  //       // Asignar tasa de comisión según nivel
  //       // const rates: { [key: number]: number } = { 1: 10, 2: 5, 3: 2.5 };
  //       // commissionRate = rates[level];
  //     }
  //   }
  ...
  //     userId: savedUser.id,
  //     level,
  //     parentId: parentId, // ← Ya no necesita conversión
  //     commissionRate,
